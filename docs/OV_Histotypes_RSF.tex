...
Method & accuracy & f1 & kappa & gmean\\
\hline
two\_step\_optimal & 0.847 & 0.65 & 0.653 & 0.701\\
\hline
\end{tabular}
\end{table}
...
Method & Metric & HGSC & CCOC & LGSC & ENOC & MUC\\
\hline
 & accuracy & 0.879 & 0.972 & 0.964 & 0.922 & 0.957\\
\cline{2-7}
 & f1 & 0.917 & 0.854 & 0.353 & 0.608 & 0.519\\
\cline{2-7}
 & kappa & 0.690 & 0.839 & 0.336 & 0.566 & 0.499\\
\cline{2-7}
\multirow{-4}{*}{\raggedright\arraybackslash two\_step\_optimal} & gmean & 0.853 & 0.945 & 0.697 & 0.706 & 0.881\\
\hline
\end{tabular}
\end{table}
