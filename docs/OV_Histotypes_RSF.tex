...
\caption{\label{tab:train-hist}Training Set Histotype Distribution}
\centering
\begin{tabular}[t]{l|r}
\hline
revHist & n\\
...
\caption{\label{tab:train-hist-codeset}Training Set Histotype Distribution by CodeSet}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
revHist & CS1 & CS2 & CS3\\
...
{\centering \includegraphics{OV_Histotypes_RSF_files/figure-latex/training-gmean-1} 

}

\caption{Training Set G-mean}\label{fig:training-gmean}
\end{figure}
