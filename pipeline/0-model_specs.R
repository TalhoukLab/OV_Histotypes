...
# Option 3: specified workflow for gene optimization
...
} else if (exists("gene_opt_wflow")) {
  wflow <- gene_opt_wflow
} else {
...
if (grepl("rf|xgb", wflow)) {
  ...
  set.seed(2024)
  tuning_grid <- crossing(grid_space_filling(penalty(), size = 10),
