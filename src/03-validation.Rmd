...
```{r cs2-none-vs-cs3, fig.cap='Gene Expression CS2 No Normalization vs. CS3'}
...
```{r cs2-pools-vs-cs3, fig.cap='Gene Expression CS2 Pools Normalization vs. CS3'}
...
```{r cs2-reference-vs-cs3, fig.cap='Gene Expression CS2 Reference Normalization vs. CS3'}
