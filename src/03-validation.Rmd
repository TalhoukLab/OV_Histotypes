...
knitr::kable(cs1_vs_cs3, caption = "CS1 vs. CS3 Median Concordance Measures by Histotypes", digits = 2)
```
...
knitr::kable(cs2_vs_cs3, caption = "CS2 vs. CS3 Median Concordance Measures by Histotypes", digits = 2)
```
