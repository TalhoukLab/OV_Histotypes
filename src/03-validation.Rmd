...
cs2_norm_rand3_byhist <- cs2_norm_rand3 %>%
  split(.$revHist) %>%
  map(select, -"revHist")

cs2_counts3_byhist <- cs2_counts3 %>% 
  rownames_to_column("ottaID") %>%
  inner_join(hist %>% distinct(ottaID, revHist), by = "ottaID") %>%
  column_to_rownames("ottaID") %>% 
  split(.$revHist) %>%
...
cs2_counts3_pools_byhist <- cs2_counts3_pools %>% 
  rownames_to_column("ottaID") %>%
  inner_join(hist %>% distinct(ottaID, revHist), by = "ottaID") %>%
  column_to_rownames("ottaID") %>% 
  split(.$revHist) %>%
...
cs3_counts3_byhist <- cs3_counts3 %>% 
  rownames_to_column("ottaID") %>%
  inner_join(hist %>% distinct(ottaID, revHist), by = "ottaID") %>%
  column_to_rownames("ottaID") %>% 
  split(.$revHist) %>%
...
rand3_stats_non <- list(cs2_counts3_byhist, cs3_counts3_byhist) %>%
  transpose() %>%
  map_dfr(~ pmap_df(.x, cor_stats, .id = "gene"), .id = "hist") %>%
  group_by(hist) %>%
  summarize_if(is.double, median) %>%
...
rand3_stats_common <- list(cs2_norm_rand3_byhist, cs3_counts3_byhist) %>%
  transpose() %>%
  map_dfr(~ pmap_df(.x, cor_stats, .id = "gene"), .id = "hist") %>%
  group_by(hist) %>%
  summarize_if(is.double, median) %>%
  ungroup() %>% 
  rename_if(is.double, ~ paste0(., "-Common"))

rand3_stats_pools <- list(cs2_counts3_pools_byhist, cs3_counts3_byhist) %>%
  transpose() %>%
  map_dfr(~ pmap_df(.x, cor_stats, .id = "gene"), .id = "hist") %>%
  group_by(hist) %>%
  summarize_if(is.double, median) %>%
  ungroup() %>% 
  rename_if(is.double, ~ paste0(., "-Pools"))

rand3_stats <-
  list(rand3_stats_non, rand3_stats_common, rand3_stats_pools) %>% 
...
##### Random2
cs2_norm_rand2_byhist <- cs2_norm_rand2 %>%
  split(.$revHist) %>%
  map(select, -"revHist")

cs2_counts2_byhist <- cs2_counts2 %>% 
  rownames_to_column("ottaID") %>%
  inner_join(hist %>% distinct(ottaID, revHist), by = "ottaID") %>%
  column_to_rownames("ottaID") %>% 
  split(.$revHist) %>%
...
cs2_counts2_pools_byhist <- cs2_counts2_pools %>% 
  rownames_to_column("ottaID") %>%
  inner_join(hist %>% distinct(ottaID, revHist), by = "ottaID") %>%
  column_to_rownames("ottaID") %>% 
  split(.$revHist) %>%
...
cs3_counts2_byhist <- cs3_counts2 %>% 
  rownames_to_column("ottaID") %>%
  inner_join(hist %>% distinct(ottaID, revHist), by = "ottaID") %>%
  column_to_rownames("ottaID") %>% 
  split(.$revHist) %>%
...
rand2_stats_non <- list(cs2_counts2_byhist, cs3_counts2_byhist) %>%
  transpose() %>%
  map_dfr(~ pmap_df(.x, cor_stats, .id = "gene"), .id = "hist") %>%
  group_by(hist) %>%
  summarize_if(is.double, median) %>%
...
rand2_stats_common <- list(cs2_norm_rand2_byhist, cs3_counts2_byhist) %>%
  transpose() %>%
  map_dfr(~ pmap_df(.x, cor_stats, .id = "gene"), .id = "hist") %>%
  group_by(hist) %>%
  summarize_if(is.double, median) %>%
...
rand2_stats_pools <- list(cs2_counts2_pools_byhist, cs3_counts2_byhist) %>%
  transpose() %>%
  map_dfr(~ pmap_df(.x, cor_stats, .id = "gene"), .id = "hist") %>%
  group_by(hist) %>%
  summarize_if(is.double, median) %>%
...
rand2_stats <-
  list(rand2_stats_non, rand2_stats_common, rand2_stats_pools) %>% 
  reduce(inner_join, by = "hist")
...
cs2_counts1_pools_byhist <- cs2_counts1_pools %>% 
  rownames_to_column("ottaID") %>%
  inner_join(hist %>% distinct(ottaID, revHist), by = "ottaID") %>%
  column_to_rownames("ottaID") %>% 
  split(.$revHist) %>%
...
rand1_stats_non <- list(cs2_counts1_byhist, cs3_counts1_byhist) %>%
  transpose() %>%
  map_dfr(~ pmap_df(.x, cor_stats, .id = "gene"), .id = "hist") %>%
  group_by(hist) %>%
  summarize_if(is.double, median) %>%
...
rand1_stats_common <- list(cs2_norm_rand1_byhist, cs3_counts1_byhist) %>%
  transpose() %>%
  map_dfr(~ pmap_df(.x, cor_stats, .id = "gene"), .id = "hist") %>%
  group_by(hist) %>%
  summarize_if(is.double, median) %>%
...
rand1_stats_pools <- list(cs2_counts1_pools_byhist, cs3_counts1_byhist) %>%
  transpose() %>%
  map_dfr(~ pmap_df(.x, cor_stats, .id = "gene"), .id = "hist") %>%
  group_by(hist) %>%
  summarize_if(is.double, median) %>%
...
rand1_stats <-
  list(rand1_stats_non, rand1_stats_common, rand1_stats_pools) %>% 
  reduce(inner_join, by = "hist")
