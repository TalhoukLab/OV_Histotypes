...
overall_accuracy_train <-
  ...
  mutate(
    ...
    mean_estimate = case_when(
      undefined == "all" ~ cell_spec(mean_estimate, background = "#FF0000"),
      undefined == "some" ~ cell_spec(mean_estimate, background = "#FFD700"),
      mean_estimate == max(mean_estimate[undefined == "none"], na.rm = TRUE) ~ cell_spec(mean_estimate, background = "#90ee90"),
