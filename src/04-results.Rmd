...
wflow_rank_agg_metrics |> 
  kbl(caption = "Top 5 Workflows from Final Rank Aggregation")
```
...
```{r metrics-top-by-metric, fig.cap=paste('Top', nrow(wflow_rank_agg_metrics), 'Workflow Per-Class Evaluation Metrics by Metric'), fig.height=7, out.width='100%'}
...
```{r gene-smote-rf, fig.cap='Gene Optimization for SMOTE-Random Forest Classifier'}
...
```{r conf-conf-mat, fig.width=8, fig.cap='Confusion Matrices for Confirmation Set Models', out.width='100%'}
...
```{r roc-curve-seq-full, fig.cap='ROC Curves for Sequential Full Model in Confirmation Set', fig.height=7, fig.width=7, out.width='100%'}
...
```{r roc-curve-seq-opt, fig.cap='ROC Curves for Sequential Optimal Model in Confirmation Set', fig.height=7, fig.width=7, out.width='100%'}
...
```{r roc-curve-smote-rf-full, fig.cap='ROC Curves for SMOTE-Random Forest, Full Set Model in Confirmation Set', fig.width=9, out.width='100%'}
...
```{r roc-curve-smote-rf-opt, fig.cap='ROC Curves for SMOTE-Random Forest, Optimal Set Model in Confirmation Set', fig.width=9, out.width='100%'}
...
```{r val-roc-curve-smote-rf-opt, fig.cap='ROC Curves for SMOTE-Random Forest, Optimal Set Model in Validation Set', fig.width=8, out.width='100%'}
