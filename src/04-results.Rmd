...
```{r conf-conf-mat, fig.width=8, fig.cap='Confusion Matrices for Confirmation Set Models'}
...
```{r roc-curve-seq-full, fig.cap='ROC Curves for Sequential Full Model in Confirmation Set', fig.width=10, out.width='100%'}
...
```{r roc-curve-seq-opt, fig.cap='ROC Curves for Sequential Optimal Model in Confirmation Set', fig.width=10, out.width='100%'}
