...
```{r metrics-top-by-class, fig.cap=paste('Top', nrow(wflow_rank_agg_comp), 'Workflow Per-Class Evaluation Metrics by Class'), fig.height=7, out.width='100%'}
...
p <-
  ...
  labs(
    ...
    y = "Metric Value",
    color = "Metric",
    title = paste("Top", nrow(wflow_rank_agg_comp), "Workflow Per-Class Evaluation Metrics by Class")
  )
print(p)
```
