...
grViz(
  paste0(
    ...
    a [shape = ellipse, label = 'Selected Cohorts for Training Set = 3674', fillcolor = '#F4CAE4']
    b [shape = ellipse, label = 'Training = 3441', fillcolor = '#F4CAE4']

    c1 [label = 'CS1 = 286', fillcolor = '#B3E2CD']
    c2 [label = 'CS2 = 882', fillcolor = '#FDCDAC']
    c3 [label = 'CS3 = 2273', fillcolor = '#CBD5E8']

    d1 [label = 'CS1 = 268', fillcolor = '#B3E2CD']
    d2 [label = 'CS2 = 832', fillcolor = '#FDCDAC']
    d3 [label = 'CS3 = 2077', fillcolor = '#CBD5E8']

    e1r [label = <CS1<sub><font point-size='10'>R</font></sub> = 5>, fillcolor = '#B3E2CD']
    e1x [label = <CS1<sub><font point-size='10'>X</font></sub> = 263>, fillcolor = '#B3E2CD']
    e2r [label = <CS2<sub><font point-size='10'>R</font></sub> = 5>, fillcolor = '#FDCDAC']
    e2x [label = <CS2<sub><font point-size='10'>X</font></sub> = 827>, fillcolor = '#FDCDAC']
    e3r [label = <CS3<sub><font point-size='10'>R</font></sub> = 5>, fillcolor = '#CBD5E8']
    e3x [label = <CS3<sub><font point-size='10'>X</font></sub> = 2072>, fillcolor = '#CBD5E8']

    f1 [label = <CS1<sub><font point-size='10'>N</font></sub> = 263>, fillcolor = '#B3E2CD']
    f2 [label = <CS2<sub><font point-size='10'>N</font></sub> = 827>, fillcolor = '#FDCDAC']
    f3 [label = <CS3<sub><font point-size='10'>N</font></sub> = 476>, fillcolor = '#CBD5E8']

    g_conf [shape = ellipse, label = 'Confirmation = 673', fillcolor = '#E6F5C9']
    g_val [shape = ellipse, label = 'Validation = 923', fillcolor = '#FFF2AE']

    h_conf [shape = ellipse, label = 'Confirmation = 643', fillcolor = '#E6F5C9']
    h_val [shape = ellipse, label = 'Validation = 894', fillcolor = '#FFF2AE']

    train_comb [shape = ellipse, label = 'Training = 1566', fillcolor = '#F4CAE4']
    train_hist [shape = ellipse, label = 'Training = 1491', fillcolor = '#F4CAE4']
    ...
    e3x -> {f3 g_conf} [color = '#A65628']
    e3x -> g_val [label = '    Split into training and test sets', color = '#A65628', fontcolor = '#A65628']
    f1 -> train_comb [xlabel = 'Recombine CodeSets        ', color = '#FF7F00', fontcolor = '#FF7F00']
    {f2 f3} -> train_comb [color = '#FF7F00']
    g_conf -> h_conf [color = '#4DAF4A']
    g_val -> h_val [color = '#4DAF4A']
    train_comb -> train_hist [xlabel = '  Remove other Histotypes', color = '#4DAF4A', fontcolor = '#4DAF4A']
    train_hist -> train_uniq [xlabel = '  Remove cross CodeSet replicates']
    ...
    subgraph {rank = same; train_comb; g_conf; g_val}
    }
    "
  )
)
