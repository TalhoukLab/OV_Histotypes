...
* CS2 pools:
  * Samples = `r ncol(cs2_pools) - 1` (Pool 1 = 3, Pool 2 = 3, Pool 3 = 3)
...
We use 6 classification algorithms and 4 subsampling methods across 500 repetitions in the supervised learning framework for CS1 and CS2. The pipeline was run using many SGE batch jobs as a way of parallelization on a CentOS 5 server. Imeplementations of the techniques below were called from the [splendid](https://alinetalhouk.github.io/splendid/) package. 
