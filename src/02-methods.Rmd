...
grViz(
  paste0(
    ...
    graph [layout = dot overlap = FALSE splines = FALSE]

    # node definitions
    node [shape = box, style = 'filled', fillcolor = 'white']
    a [shape = ellipse, label = 'Selected Cohorts from all CodeSets\nN = 3674', fillcolor = '#F4CAE4']
    b [shape = ellipse, label = 'Samples Passed QC\nN = 3441', fillcolor = '#F4CAE4']
    c1 [label = 'CS1 = 286', fillcolor = '#B3E2CD']
    c2 [label = 'CS2 = 882', fillcolor = '#FDCDAC']
    c3 [label = 'CS3 = 2273', fillcolor = '#CBD5E8']

    d1r [label = <CS1<sub><font point-size='10'>R</font></sub> = 7>, fillcolor = '#B3E2CD']
    d1x [label = <CS1<sub><font point-size='10'>X</font></sub> = 279>, fillcolor = '#B3E2CD']
    d2r [label = <CS2<sub><font point-size='10'>R</font></sub> = 6>, fillcolor = '#FDCDAC']
    d2x [label = <CS2<sub><font point-size='10'>X</font></sub> = 876>, fillcolor = '#FDCDAC']
    d3r [label = <CS3<sub><font point-size='10'>R</font></sub> = 9>, fillcolor = '#CBD5E8']
    d3x [label = <CS3<sub><font point-size='10'>X</font></sub> = 2264>, fillcolor = '#CBD5E8']

    e3van [label = <CS3-VAN<sub><font point-size='10'>X</font></sub> = 2178>, fillcolor = '#E6F5C9']
    e3usc [label = <CS3-USC<sub><font point-size='10'>X</font></sub> = 45>, fillcolor = '#FFF2AE']
    e3aoc [label = <CS3-AOC<sub><font point-size='10'>X</font></sub> = 41>, fillcolor = '#F1E2CC']

    f1r [label = <CS1<sub><font point-size='10'>R</font></sub> = 5>, fillcolor = '#B3E2CD']
    f1x [label = <CS1<sub><font point-size='10'>X</font></sub> = 263>, fillcolor = '#B3E2CD']
    f2r [label = <CS2<sub><font point-size='10'>R</font></sub> = 5>, fillcolor = '#FDCDAC']
    f2x [label = <CS2<sub><font point-size='10'>X</font></sub> = 827>, fillcolor = '#FDCDAC']
    f3r [label = <CS3<sub><font point-size='10'>R</font></sub> = 5>, fillcolor = '#CBD5E8']

    f3van [label = <CS3-VAN<sub><font point-size='10'>X</font></sub> = 2094>, fillcolor = '#E6F5C9']
    f3usc [label = <CS3-USC<sub><font point-size='10'>X</font></sub> = 28>, fillcolor = '#FFF2AE']
    f3usc_pools [label = <CS3-USC<sub><font point-size='10'>R</font></sub> = 17>, fillcolor = '#FFF2AE']
    f3aoc [label = <CS3-AOC<sub><font point-size='10'>X</font></sub> = 22>, fillcolor = '#F1E2CC']
    f3aoc_pools [label = <CS3-AOC<sub><font point-size='10'>R</font></sub> = 19>, fillcolor = '#F1E2CC']

    g3usc [label = <CS3-USC<sub><font point-size='10'>N</font></sub> = 28>, fillcolor = '#FFF2AE']
    g3aoc [label = <CS3-AOC<sub><font point-size='10'>N</font></sub> = 22>, fillcolor = '#F1E2CC']

    h1 [label = <CS1<sub><font point-size='10'>N</font></sub> = 263>, fillcolor = '#B3E2CD']
    h2 [label = <CS2<sub><font point-size='10'>N</font></sub> = 827>, fillcolor = '#FDCDAC']
    h3 [label = <CS3<sub><font point-size='10'>N</font></sub> = 520>, fillcolor = '#CBD5E8']

    train_all [shape = ellipse, label = 'Normalized Expression from all CodeSets\nN = 1610', fillcolor = '#F4CAE4']
    train_hist [shape = ellipse, label = 'Major Histotypes\nN = 1535', fillcolor = '#F4CAE4']
    train_uniq [shape = ellipse, label = 'Final Training\nN = 1243', fillcolor = '#F4CAE4']

    # edge definitions
    edge [penwidth = 2, arrowsize = 0.5]
    a -> b [label = '  Quality Control']
    b -> {c1 c2} [tailport = 's', color = '#FF7F00']
    b -> c3 [label = 'Split by CodeSets', tailport = 's', color = '#FF7F00', fontcolor = '#FF7F00']
    c1 -> {d1x d1r} [tailport = 's', color = '#984EA3']
    c2 -> {d2x d2r} [tailport = 's', color = '#984EA3']
    c3 -> d3x [label = 'Split into Expression and Reference Samples', tailport = 's', color = '#984EA3', fontcolor = '#984EA3']
    c3 -> d3r [color = '#984EA3']
    d1x -> f1x [color = '#377EB8']
    d1r -> f1r [color = '#377EB8']
    d2x -> f2x [color = '#377EB8']
    d2r -> f2r [color = '#377EB8']
    d3x -> {e3van e3usc} [tailport = 's', color = '#A65628']
    d3x -> e3aoc [label = '  Split by site', tailport = 's', color = '#A65628', fontcolor = '#A65628']
    d3r -> f3r [color = '#377EB8']
    e3van -> f3van [tailport = 's', color = '#377EB8']
    e3usc -> {f3usc f3usc_pools} [tailport = 's', color = '#377EB8']
    e3aoc -> f3aoc [tailport = 's', color = '#377EB8']
    e3aoc -> f3aoc_pools [tailport = 's', color = '#377EB8', label = 'Remove duplicates and separate pools', fontcolor = '#377EB8']
    f1r -> h1 [headport = 'n', xlabel = 'Normalization by Random1                 ', color = '#E41A1C', fontcolor = '#E41A1C']
    {f1x f3r} -> h1 [headport = 'n', color = '#E41A1C']
    {f2x f2r f3r} -> h2 [headport = 'n', color = '#E41A1C']
    {f3usc f3usc_pools} -> g3usc [headport = 'n', color = '#4DAF4A']
    f3aoc -> g3aoc [headport = 'n', color = '#4DAF4A']
    f3aoc_pools -> g3aoc [headport = 'n', color = '#4DAF4A', label = 'Normalization by Pools', fontcolor = '#4DAF4A']
    {f3van g3usc} -> h3 [color = '#A65628']
    g3aoc -> h3 [label = 'Recombine sites\nRemove test sets and pools', color = '#A65628', fontcolor = '#A65628']
    {h1 h2} -> train_all [color = '#FF7F00']
    h3 -> train_all [label = '  Recombine CodeSets', color = '#FF7F00', fontcolor = '#FF7F00']
    ...
    subgraph {rank = same; d1r; d1x; d2r; d2x; d3r; d3x}
