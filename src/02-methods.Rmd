...
Using some of the notation from Equation \@ref(eq:sequential), a flowchart similar to Figure \@ref(fig:sequential-flowchart) can show how the two-step algorithm works:
