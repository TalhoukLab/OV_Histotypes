...
```{r}
#| label: fig-val-metrics-up-xgb
#| fig-cap: 'Up-XGB, Full Set, Per-Class Metrics in Validation Set'
#| fig-width: 8
#| out-width: '100%'
...
p <- ggplot(val_metrics_top) +
  ...
  labs(
    y = "Metric Value",
    title = paste("Up-XGB, Full Set, Per-Class Metrics in Validation Set")
  )
print(p)
```
