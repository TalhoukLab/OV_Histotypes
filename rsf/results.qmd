...
#| fig-cap: 'Gene Optimization for Up-XGB Classifier'
#| fig-height: 5
#| fig-width: 5
#| out-width: '100%'
...
p_gene_up_xgb <- 
  ...
  labs(
    x = "Genes Added",
    y = "F1-Score",
    title = paste0("Gene Optimziation for Up-XGB Classifier ", unique(dat_gene_up_xgb$.metric))
  )
...
In the Up-XGB classifier, the mean F1-score is highest when we reach `r n_genes_up_xgb` genes added, hence the optimal number of genes used will be n=`r length(overlap_all)`+`r n_genes_up_xgb`=`r length(opt_genes_up_xgb)` The added genes are: `r str_flatten_comma(genes_add_up_xgb, last = " and ")`.
...
#| fig-cap: 'Gene Optimization for SMOTE-SVM Classifier'
#| fig-height: 5
#| fig-width: 5
#| out-width: '100%'
...
p_gene_smote_svm <- 
  ...
  labs(
    x = "Genes Added",
    y = "F1-Score",
    title = paste0("Gene Optimziation for SMOTE-SVM using ", unique(dat_gene_smote_svm$.metric))
  )
...
In the SMOTE-SVM classifier, the mean F1-score is optimal with `r n_genes_smote_svm` genes added, hence the optimal number of genes used will be n=`r length(overlap_all)`+`r n_genes_smote_svm`=`r length(opt_genes_smote_svm)` The added genes are: `r str_flatten_comma(genes_add_smote_svm, last = " and ")`.
