...
all_metrics_train |> 
  summarize_metrics(metric = "accuracy", per_class = FALSE) |> 
  kbl(escape = FALSE) |> 
  kable_styling() |> 
...
```{r}
#| label: fig-train-accuracy-class
#| fig-cap: 'Training Set Class-Specific Mean Accuracy'
#| fig-height: 8
...
```{r}
#| label: tbl-train-accuracy-class
#| tbl-cap: 'Training Set Class-Specific Mean Accuracy'

all_metrics_train |> 
  summarize_metrics(metric = "accuracy", per_class = TRUE) |> 
  kbl(escape = FALSE) |> 
  kable_styling() |> 
...
all_metrics_train |>
  summarize_metrics(metric = "sensitivity", per_class = FALSE) |>
  kbl(escape = FALSE) |>
  kable_styling() |>
  add_header_above(c(" " = 1, "Algorithms" = 4))
```
...
```{r}
#| label: fig-train-sens-class
#| fig-cap: 'Training Set Class-Specific Mean Sensitivity'
#| fig-height: 8
...
```{r}
#| label: tbl-train-sens-class
#| tbl-cap: 'Cross-Validated Training Set Class-Specific Mean Sensitivity'

all_metrics_train |>
  summarize_metrics(metric = "sensitivity", per_class = TRUE) |>
  kbl(escape = FALSE) |>
  kable_styling() |>
  add_header_above(c(" " = 2, "Algorithms" = 4))
```
...
all_metrics_train |>
  summarize_metrics(metric = "specificity", per_class = FALSE) |>
  kbl(escape = FALSE) |>
  kable_styling() |>
  add_header_above(c(" " = 1, "Algorithms" = 4))
```
...
```{r}
#| label: fig-train-spec-class
#| fig-cap: 'Training Set Class-Specific Mean Specificity'
#| fig-height: 8
...
```{r}
#| label: tbl-train-spec-class
#| tbl-cap: 'Training Set Class-Specific Mean Specificity'

all_metrics_train |>
  summarize_metrics(metric = "specificity", per_class = TRUE) |>
  kbl(escape = FALSE) |>
  kable_styling() |>
  add_header_above(c(" " = 2, "Algorithms" = 4))
```
...
all_metrics_train |>
  summarize_metrics(metric = "f_meas", per_class = FALSE) |>
  kbl(escape = FALSE) |>
  kable_styling() |>
  add_header_above(c(" " = 1, "Algorithms" = 4))
```
...
```{r}
#| label: fig-train-f1-class
#| fig-cap: 'Training Set Class-Specific Mean F1-Score'
#| fig-height: 8
...
```{r}
#| label: tbl-train-f1-class
#| tbl-cap: 'Training Set Class-Specific Mean F1-Score'

all_metrics_train |>
  summarize_metrics(metric = "f_meas", per_class = TRUE) |>
  kbl(escape = FALSE) |>
  kable_styling() |>
  add_header_above(c(" " = 2, "Algorithms" = 4))
```
...
all_metrics_train |>
  summarize_metrics(metric = "bal_accuracy", per_class = FALSE) |>
  kbl(escape = FALSE) |>
  kable_styling() |>
  add_header_above(c(" " = 1, "Algorithms" = 4))
```
...
```{r}
#| label: fig-train-bal-accuracy-class
#| fig-cap: 'Training Set Class-Specific Mean Balanced Accuracy'
#| fig-height: 8
...
```{r}
#| label: tbl-train-bal-accuracy-class
#| tbl-cap: 'Training Set Class-Specific Mean Balanced Accuracy'

all_metrics_train |>
  summarize_metrics(metric = "bal_accuracy", per_class = TRUE) |>
  kbl(escape = FALSE) |>
  kable_styling() |>
  add_header_above(c(" " = 2, "Algorithms" = 4))
```
...
all_metrics_train |>
  summarize_metrics(metric = "kap", per_class = FALSE) |>
  kbl(escape = FALSE) |>
  kable_styling() |>
  add_header_above(c(" " = 1, "Algorithms" = 4))
```
...
```{r}
#| label: fig-train-kappa-class
#| fig-cap: 'Training Set Class-Specific Mean Kappa'
#| fig-height: 8
...
```{r}
#| label: tbl-train-kappa-class
#| tbl-cap: 'Training Set Class-Specific Mean Kappa'

all_metrics_train |>
  summarize_metrics(metric = "kap", per_class = TRUE) |>
  kbl(escape = FALSE) |>
  kable_styling() |>
  add_header_above(c(" " = 2, "Algorithms" = 4))
```
...
```{r}
#| label: fig-train-gmean
#| fig-cap: 'Training Set Mean G-mean'
...
```{r}
#| label: tbl-train-gmean
#| tbl-cap: 'Training Set Mean G-mean'

all_metrics_train |>
  summarize_metrics(metric = "gmean", per_class = FALSE) |>
  kbl(escape = FALSE) |>
  kable_styling() |>
  add_header_above(c(" " = 1, "Algorithms" = 4))
```
...
```{r}
#| label: fig-train-gmean-class
#| fig-cap: 'Training Set Class-Specific Mean G-mean'
#| fig-height: 8
...
```{r}
#| label: tbl-train-gmean-class
#| tbl-cap: 'Training Set Class-Specific Mean G-mean'

all_metrics_train |>
  summarize_metrics(metric = "gmean", per_class = TRUE) |>
  kbl(escape = FALSE) |>
  kable_styling() |>
  add_header_above(c(" " = 2, "Algorithms" = 4))
```
...
We look at the per-class evaluation metrics of the top `r nrow(wflow_rank_agg_metrics)` workflows.

```{r}
#| label: fig-metrics-top-by-metric
#| fig-cap: !expr paste('Top', nrow(wflow_rank_agg_metrics), 'Workflow Per-Class Evaluation Metrics by Metric')
#| fig-height: 7
#| out-width: '100%'
...
p <-
  ...
  labs(
    ...
    y = "Metric Value",
    color = "Class",
    title = paste("Top", nrow(wflow_rank_agg_metrics), "Workflow Per-Class Evaluation Metrics by Metric")
  )
print(p)
```
...
kable(conf_eval,
      caption = "Evaluation Metrics on Confirmation Set Models",
      digits = 3) %>% 
  kable_styling() %>% 
  collapse_rows(columns = 1) %>% 
...
kbl(val_eval,
    caption = "Evaluation Metrics on Validation Set Model, SMOTE-Random Forest, Optimal Set",
    digits = 3) |>
  kable_styling() %>%
  collapse_rows(columns = 1) %>%
...
preds <- predict(mod_smote_rf_opt, val_data, type = "prob") |> 
