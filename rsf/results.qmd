...
```{r}
#| label: fig-val-roc-curve-up-xgb-full
...
val_all_volcano <- ggplot(res_all, aes(x = log2FoldChange, y = -log10(padj))) +
  ...
  labs(
    ...
    title = "Volcano Plots of Validation Set Predictions",
...
bind_rows(
  ...
  select(Dataset, ottaID, GAD1, LGALS4, hist_gr2) |>
  mutate(hist_gr2 = fct_recode(
    hist_gr2,
    HGSOC = "HGSC",
    MUOC = "MUC",
    LGSOC = "LGSC",
